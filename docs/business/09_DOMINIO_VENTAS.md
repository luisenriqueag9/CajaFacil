...
- **Existencias físicas (Stock)**: El control de existencias corresponde al contexto de [Inventario](file:///docs/business/07_DOMINIO_INVENTARIO.md).
- **Control de efectivo físico**: El dinero físico en la gaveta y su cuadre corresponden al contexto de [Caja](file:///docs/business/10_DOMINIO_CAJA.md).
