---
id: CF-DOC-016
title: "Modelo Lógico de Datos - Empresa y Seguridad"
...
> [!NOTE]
> Este documento depende de las especificaciones canónicas de negocio: [Dominio Empresa](file:///docs/business/13_DOMINIO_EMPRESA.md) y [Dominio Seguridad](file:///docs/business/12_DOMINIO_SEGURIDAD.md).
