---
id: CF-DOC-017
title: "Modelo Lógico de Datos - Productos e Inventario"
...
> [!NOTE]
> Este documento depende de las especificaciones canónicas de negocio: [Dominio Producto](file:///docs/business/04_DOMINIO_PRODUCTO.md) y [Dominio Inventario](file:///docs/business/07_DOMINIO_INVENTARIO.md).
