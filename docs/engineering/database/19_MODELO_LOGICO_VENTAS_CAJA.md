---
id: CF-DOC-019
title: "Modelo Lógico de Datos - Ventas y Caja"
...
> [!NOTE]
> Este documento depende de las especificaciones canónicas de negocio: [Dominio Ventas](file:///docs/business/09_DOMINIO_VENTAS.md) y [Dominio Caja](file:///docs/business/10_DOMINIO_CAJA.md).
