...
class ReversarCargoCreditoUseCase:
    def __init__(
        self,
    ...
    def execute(self, command: ReversarCargoCreditoCommand) -> CreditoDTO:
        ...
        credito.release_debt(command.amount, reference_id=command.reference_id, timestamp=now)
